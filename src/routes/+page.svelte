<section class="container mx-auto px-1 py-1">
    <div class="grid grid-cols-1 lg:grid-rows-2 lg:grid-cols-4 gap-1">
        <div class="lg:col-span-2 lg:row-span-2 relative ">
            ...
            <div class="absolute left-10 top-[14rem]">
                <h2 class="text-6xl text-slate-800 ">Women's Fashion</h2>
                <p class="my-4 max-w-md text-lg text-slate-500">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Doloremque odit autem iusto velit. Cumque
                    quisquam maiores dolor voluptatibus recusandae est id, totam nam sunt, dolorem necessitatibus omnis!
                    Alias, facere dolore.
                </p>
                <button
                    class="font-bold text-lg font-mono underline underline-offset-8 decoration-red-500 text-slate-800 uppercase">Shop
                    now</button>
            </div>
        </div>
        <div
            ...
            <div class="font-sans font-bold  mx-4">
